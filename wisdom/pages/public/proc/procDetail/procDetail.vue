<template>
	<view class="proc-wrap">
		...
		<view class="detail-view content-box" v-if="TabCur === 0">
			<view class="detail-form"><bxform ref="bxDetailForm" :pageType="type" :BxformType="'detail'" :fields="fields"></bxform></view>
		</view>
		...
		<uni-popup ref="approvalPopup" type="bottom">
			<view class="form-view" v-if="stepsCfgData.length > 0">
				...
				></bxform>
				<bxform
					v-if="procBasicConfig.proHanleData && procBasicConfig.proHanleData.activeStep !== 0 && !isHandler && activityData && detailFiledData"
					ref="approvalForm"
					:pageType="'add'"
					class="approvalForm"
					:BxformType="'add'"
				...
				></bxform>
				<view class="button-box" v-if="procBasicConfig.proHanleData && !isHandler">
